...
<div class="ph-infinite-slider gos_programs">
    <div class="data-item" data-image-url="<?= $ph->image_path('main/gos_programs/newmaterial.png') ?>">
    ...
    <div class="data-item" data-image-url="<?= $ph->image_path('main/gos_programs/plazmteh.png') ?>">
    ...
    <div class="data-item" data-image-url="<?= $ph->image_path('main/gos_programs/mashinostoenie.png') ?>">
    ...
    <div class="data-item" data-image-url="<?= $ph->image_path('main/gos_programs/roboti.png') ?>">
